...
NotebookDataLength[     36044,        779]
NotebookOptionsPosition[     35948,        764]
NotebookOutlinePosition[     36460,        782]
CellTagsIndexPosition[     36417,        779]
WindowFrame->Normal*)
...
Cell[BoxData["`"], "Input",
 CellChangeTimes->{
  3.915893139147104*^9},ExpressionUUID->"f3eeb3a6-9757-4ea1-94a9-\
733d7ae0bf8d"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.655988388292108*^9, 3.655988489607903*^9}, {
   ...
   3.6560218161744084`*^9}, {3.6560225956593494`*^9, 
   3.656022604787262*^9}},ExpressionUUID->"10c3e0a5-e5c3-43f8-ac14-\
7690dbde9cb4"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{
  3.656018204066828*^9, 3.6560182636098275`*^9, 3.6560183384218273`*^9, {
   ...
   3.795115562812195*^9},ExpressionUUID->"94911e26-1e2c-42d6-b501-\
6894f33356b5"]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.429610822746764*^9, 3.4296108241686487`*^9}, {
   ...
   3.6560203268476167`*^9}, {3.6560203897366166`*^9, 3.6560204103176165`*^9},
    {3.6560205283466167`*^9, 3.6560205469946165`*^9}, 3.6560205972886167`*^9, 
   3.656020641778617*^9, {3.6560207247346163`*^9, 3.6560207963096166`*^9}, 
   3.6560208747626166`*^9, 3.6560209823486166`*^9, {3.6560210187286167`*^9, 
   3.6560210712776165`*^9}, {3.656021156957617*^9, 3.656021210078805*^9}, {
   3.656021361624958*^9, 3.656021382780073*^9}, {3.656021428219617*^9, 
   3.6560214544602404`*^9}, {3.656021492951089*^9, 3.6560215519029837`*^9}, {
   3.656021598947688*^9, 3.6560216286556587`*^9}, 3.6560216596887617`*^9, 
   3.6560216916379557`*^9, {3.656021821802971*^9, 3.656021830101801*^9}, {
   3.656022111260914*^9, 3.656022167154503*^9}, {3.65602222753054*^9, 
   3.656022233568144*^9}, {3.6560223902988153`*^9, 3.656022473043089*^9}, 
   3.656022800971878*^9, {3.7811214622383676`*^9, 3.7811214860030327`*^9}, {
   3.7811216501743584`*^9, 3.7811216618462176`*^9}, {3.781121708651357*^9, 
   3.781121718772724*^9}, {3.781121781985117*^9, 3.781121802233415*^9}, {
   3.781121841726195*^9, 3.7811218503670964`*^9}, {3.781132209407425*^9, 
   3.781132210378996*^9}, 3.781132308108039*^9, 3.7811324333136344`*^9, {
   3.7811325237312346`*^9, 3.7811326121761155`*^9}, {3.781132790620784*^9, 
   3.7811328002035694`*^9}, {3.7951145094509935`*^9, 
   3.7951145097328663`*^9}, {3.795115133015294*^9, 3.795115136757509*^9}, {
   3.7951152190622644`*^9, 3.7951152473522997`*^9}, 3.795115278861359*^9, {
   3.7951153500180893`*^9, 3.795115352492645*^9}, {3.795115387991075*^9, 
   3.795115388566103*^9}, 
   3.7951155490901823`*^9},ExpressionUUID->"0284fa2f-8214-4f0f-9234-\
4b00795a7ba1"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`d$$ = 3.75, $CellContext`L$$ = 
    1.466, $CellContext`n$$ = 4, $CellContext`t$$ = 0.30000000000000004`, 
    ...
    Typeset`size$$ = {921.6, {234., 237.52500000000003`}}, Typeset`update$$ = 
...
$CellContext`n$$, $CellContext`d$$], 190 Tan[$CellContext`t$$]}}, PlotStyle -> {
     ...
     ImageSizeCache->{958., {296.2072264784016, 300.7927735215984}},
 ...
 CellChangeTimes->{
  3.781132700357251*^9, 3.7951147052377467`*^9, {3.7951149234192557`*^9, 
   ...
   3.7951155635118146`*^9, 
   3.795115564110629*^9}},ExpressionUUID->"d7876ed1-edd2-4e68-9963-\
2fb80960e515"]
}, {2}]]
},
...
ExpressionUUID->"5a474c82-7c10-4cb7-b959-21916f153ab0"
]
...
(*NotebookFileOutline
Notebook[{
Cell[1464, 33, 129, 3, 22, "Input",ExpressionUUID->"f3eeb3a6-9757-4ea1-94a9-733d7ae0bf8d"],
Cell[CellGroupData[{
Cell[1618, 40, 1573, 36, 15, "Input",ExpressionUUID->"10c3e0a5-e5c3-43f8-ac14-7690dbde9cb4",
 CellOpen->False,
 InitializationCell->True],
Cell[3194, 78, 1174, 24, 15, "Output",ExpressionUUID->"94911e26-1e2c-42d6-b501-6894f33356b5",
 CellOpen->False]
}, Open  ]],
Cell[CellGroupData[{
Cell[4405, 107, 24062, 498, 457, "Input",ExpressionUUID->"0284fa2f-8214-4f0f-9234-4b00795a7ba1",
 InitializationCell->True],
Cell[28470, 607, 7465, 154, 612, "Output",ExpressionUUID->"d7876ed1-edd2-4e68-9963-2fb80960e515"]
}, {2}]]
}
]
*)

(* NotebookSignature YuTmYmwZAG@l#Dg4alHm6lwh *)
