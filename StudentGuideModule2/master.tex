...
%\includeonly{doppler_shift/doppler_shift,resonance_tubes}
...
\includelab{1}{magnetism_3/magnetism_3}
...
\includelab{1}{induction1/electromagnetic_induction}
...
\includelab{1}{interference_of_light/interference_of_light}
\includelab{1}{diffraction_of_light/diffraction_of_light}
