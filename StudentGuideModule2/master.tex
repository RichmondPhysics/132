...
%\includeonly{deriving_em_waves/deriving_em_waves}
...
\includelab{1}{refraction_at_spherical_surfaces}
...
\includelab{1}{hydrogen} %this would normally go in the quantum section, I think. --MT


%--------------------------------------------
%\part{Quantum Mechanics}

%\includelab{1}{hydrogen} %moved to optics for fall 2015
