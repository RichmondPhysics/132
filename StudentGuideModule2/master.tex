...
%\includeonly{elec_potential_example/elec_potential_example}
...
\
\setcounter{page}{2} %changed from 1 to 2 on 6/9/15 by MT.  The reason is that in the circuit labs, the even/odd pages need to correspond with front/back, respectively, to get the cutout figures to appear on the correct side.
...
\include{em_plane_waves/em_plane_waves}
