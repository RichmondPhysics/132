...
%--------------------------------------------------------------------------------------------------------------
\begin{Exercise}
Consider the problem from Lab~6 where you found the electric field $\vec{E}$ a distance $x$ from  a charged rod.  
(a)~Express your final answer for $\vec{E}$ in terms of the charge density $\lambda$ per unit length, rather than $Q$ and $L$.  
...
\end{Exercise}
\begin{Answer}
(a) $\displaystyle E=\frac{k_e \lambda }{x \sqrt{(x/L)^2 + (1/2)^2}}$  (b) $\displaystyle E=\frac{2\pi k_e}{x}$
\end{Answer}
}

%--------------------------------------------------------------------------------------------------------------
\begin{Exercise}
A thin rod has charge $Q$ and length $L$. Find the electric field $\vec{E}$ at a point $P$ that lies along the rod's axis and is a distance $d$ from the end of the rod.  (\textit{Hint: put the rod along the $x$ axis with point $P$ at the origin.})
\begin{center}
...
%--------------------------------------------------------------------------------------------------------------
\figuretoright{0.30}[scale=0.95]{M_problems/charges/charges_in_cube.pdf}{
\begin{Exercise}
...
%--------------------------------------------------------------------------------------------------------------
\figuretoright{0.20}[scale=0.95]{M_problems/charges/120_degree_arc.pdf}{
\begin{Exercise}
...
%--------------------------------------------------------------------------------------------------------------
\figuretoright{0.40}[scale=0.95]{M_problems/charges/nested_spheres.pdf}{
\begin{Exercise}
