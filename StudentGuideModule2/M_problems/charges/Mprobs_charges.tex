...
\begin{enumerate}[labparts, nosep, topsep=-2ex, after={\vspace{2ex}}]
...
\begin{Exercise}
The figure below on the left shows a solid metal sphere at the center of a hollow metal shell.  
...
\hspace*{\fill}
\includegraphics{M_problems/charges/nested_spheres.pdf}
\hspace*{\fill}
\includegraphics{M_problems/charges/three_rods_prism.pdf}
\hspace*{\fill}

%--------------------------------------------------------------------------------------------------------------
%\figuretoright{0.30}[scale=0.95]{M_problems/charges/three_rods_prism.pdf}{
\begin{Exercise}
The figure above on the right shows a closed surface that is a triangular prism of height $h$, for which the top and bottom surfaces are equilateral triangles of side length $\ell$.  
Three infinitely long vertical rods with uniform positive charge per length $\lambda$ are symmetrically placed near each of the three corners of the triangles. What is the electric flux through one of the rectangular faces of the prism?
\end{Exercise}
\begin{Answer}
$\lambda h / \epsilon_0$
\end{Answer}
