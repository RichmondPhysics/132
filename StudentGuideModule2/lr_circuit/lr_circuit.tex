...
\vspace{0.3cm}
{\centering \resizebox*{0.75\textwidth}{!}{\includegraphics{lr_circuit/lr_circuit_fig_1.pdf}} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\centering \resizebox*{0.75\textwidth}{!}{\includegraphics{lr_circuit/lr_circuit_fig_2.pdf}} \par}
\vspace{0.3cm}
