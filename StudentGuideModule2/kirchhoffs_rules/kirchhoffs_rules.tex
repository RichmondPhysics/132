...
parallel to derive expressions for the three currents.
\answerspace{50mm}

\item Are the results of 3 and 4 the same? They should be.
\answerspace{15mm}
...
which are mounted on the wooden block.
\answerspace{15mm}

\item \textbf{Prediction}: if the emf, \( \varepsilon  \), were 5.0 V,
what do you predict the three currents would be?
\answerspace{30mm}
...
on the power supply and set \( \varepsilon  \) to about 5.0 V. Record \( \varepsilon  \) and I\( _{A} \), then turn off the power supply.
\answerspace{15mm}
