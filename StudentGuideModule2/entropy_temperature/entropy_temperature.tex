...
AJP 65 (1), 26-36, (1997), 
\url{http://physics.weber.edu/schroeder/statmech.pdf}} %I think maybe the \url only works in pdflatex?  --MT; Works in xelatex with \usepackage{hyperref} in labmanual_formatting_commands.tex - gpg
...
document. 
In {\it Word} edit out any non-numerical text and the commas (`,') and asterisks (`*') in the file 
(use the {\tt Replace}
...
(c) What is $E_A$ for the most probable microstate? What mathematical condition can you impose
on the total entropy $S_{AB}$ to determine the most probable microstate?
...
(f) If the energy $E_A$ and $q_A$ of solid $A$ increases what should the temperature 
of solid $A$ do?
