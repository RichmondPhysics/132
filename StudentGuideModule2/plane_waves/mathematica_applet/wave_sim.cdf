 ...
 RowBox[{"Manipulate", "[", "\[IndentingNewLine]", 
  RowBox[{
         ...
         RowBox[{"InfinitePlane", "[", 
          RowBox[{
           RowBox[{"Dynamic", "[", 
            RowBox[{"{", 
             RowBox[{
              RowBox[{"CrossSectPos", "-", "xrclip", "-", ".05"}], ",", "0", 
              ",", "0"}], "}"}], "]"}], ",", 
           RowBox[{"{", 
            RowBox[{
             RowBox[{"{", 
   ...
   RowBox[{"{", 
    RowBox[{
     RowBox[{"{", 
      RowBox[{"showE", ",", "1", ",", "\"\<Show E\>\""}], "}"}], ",", 
     RowBox[{"{", 
      RowBox[{"1", ",", "0"}], "}"}]}], "}"}], ",", 
   RowBox[{"{", 
    RowBox[{
     RowBox[{"{", 
      RowBox[{"showB", ",", "1", ",", "\"\<Show B\>\""}], "}"}], ",", 
     RowBox[{"{", 
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`CrossSectPos$$ = 8 
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
      ...
      Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`showE$$], 1, "Show E"}, {1, 0}}, {{
       Hold[$CellContext`showB$$], 1, "Show B"}, {1, 0}}, {
      Hold[
...
{$CellContext`zz, -$CellContext`domultz$$, $CellContext`domultz$$}], 
         Table[{
           Graphics3D[{Gray, 
             Opacity[0.4 $CellContext`showwavefronts$$], 
             EdgeForm[
              Directive[
               Opacity[$CellContext`showwavefronts$$]]], 
             
             InfinitePlane[{(4 $CellContext`xx - 3) (Pi/2), 0, 0}, {{0, 0, 
              1}, {0, 1, 0}}]}]}, {$CellContext`xx, 0, $CellContext`Maxx}], 
         Graphics3D[{White, 
...
$CellContext`xrclip$$}, {-2, 2}, {-2, 2.01}}]]), 
      "Specifications" :> {{{$CellContext`xrclip$$, 0, 
          Style["Time:", 10, Bold]}, 0, 2 Pi, Appearance -> "Open", 
         SynchronousUpdating -> True}, Delimiter, 
        Style[
        ...
        "Electric and Magnetic Components:", 10, 
         Bold], {{$CellContext`showE$$, 1, "Show E"}, {1, 
         0}}, {{$CellContext`showB$$, 1, "Show B"}, {1, 0}}, Delimiter, 
        Style[
        "Graphic Elements:", 10, 
...
\n and then restart it (play) after changing any check boxes.", Italic]}, 
 ...
 CellChangeTimes->{
  3.848760269246744*^9, {3.8487603203126755`*^9, 3.8487603683142605`*^9}, {
   3.8487606156412807`*^9, 3.8487606536006975`*^9}, 3.8487606943798647`*^9, {
   3.8487607362802753`*^9, 3.8487607632040224`*^9}, {3.848760811551513*^9, 
