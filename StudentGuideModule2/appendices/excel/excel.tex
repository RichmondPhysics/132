...
\begin{figure}[b!]
\centerline{\includegraphics[width=3in]{appendices/excel/excelwindow.eps}}
...
\includegraphics[width=0.2in]{appendices/excel/scatterplot.eps}.  
...
\begin{figure}[b!]
\begin{center}
\includegraphics[height=2.5in]{appendices/excel/histf1.eps}
\hspace{0.4in}
\includegraphics[height=2.5in]{appendices/excel/histf2.eps}
...
\begin{figure}[b!]
\begin{center}
\includegraphics[height=2.5in]{appendices/excel/histf3.eps}\hspace{0.4in}\includegraphics[height=2.5in]{appendices/excel/histf4.eps}
