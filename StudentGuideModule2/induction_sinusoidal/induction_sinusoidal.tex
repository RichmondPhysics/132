...
\begin{enumerate}[labparts]
\item Suppose we have a current $I$ in a circular wire of radius $R$.  What will be the magnitude of the magnetic field $B_z$ at the center of the coil? (Answer in terms of $I$ and $R$ and any other physical constants like $\mu_0$.)
\answerspace{1.2in}

\item The big coil you actually used is also basically a big circle of wire, carrying a current given by the equation
$$
...
\item Now suppose that the small coil consists of $N_2$ loops of wire,
each having area $A$.  Write down an expression for $\Phi_B(t)$, the
flux through the small coil.
\answerspace{0.8in}

\item Using Faraday's Law, give an expression for ${\cal E}(t)$, the emf in
the small coil.
\answerspace{0.8in}
