...
The current version of this lab is based on an earlier version that gave a very prescriptive set of instructions for students.  (It wasn't quite like filling out a tax form, with ``subtract line 13 from line 12,'' but it was close.)
