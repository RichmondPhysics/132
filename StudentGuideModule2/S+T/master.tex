...
\author{Emory S. Bunn,$^1$ Gerard P. Gilfoyle,$^1$ Philip D. Rubin,$^2$ and Michael F. Vineyard$^3$\\[4pt]
$^1$Department of Physics, University of Richmond, VA \\[4pt]
$^2$Department of Physics, George Mason University, Fairfax, VA \\[4pt]
$^2$Department of Physics, Union College, Schenectady, NY}
...
%\include{einstein_solid}

\include{entropy_temperature}
...
%\include{electromagnetic_induction2}
