...
Once you hit \textit{Preview}, the current value of temperature will be continuously updated in the table. When you begin taking data, one member of your team will heat the air chamber in the flask on the hot plate 
and call out the position of the piston.
Another member will record the position settings by hand in the table below
and
click the \textit{Keep Sample} button to record the 
...
the \textit{Preview} button. You can monitor the temperature
on the temperature versus time plot to the right.
Make sure the set screw on the side of the piston is released.

(d) When the temperature is stable click the \textit{Keep Sample} button and that point will be recorded in the
...
will click the \textit{Keep Sample} button (recording the temperature) and record the piston position
in the table.
