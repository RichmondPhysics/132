...
\section{Activity 0: Introduction to Multimeter and Resistors}
...
(2) Use the table in Appendix C to identify the resistance of the following resistors
\includegraphics[width=0.3\textwidth]{electric_circuits2/resistors.png}
