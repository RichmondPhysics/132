...
\instructornote{%
By Matt, 2015.  Time: long! (maybe 2 hours?)
...
For the multimeters, have plenty of extra fuses on hand, as some fuses will be blown!  Also, I haven't tried this yet, but we could try setting the current limiter dial of the power supply to about 400 mA, then putting masking tape over the knob to discourage students from changing it, which could blow out DMM fuses.  
...
%\begin{center}
\hspace{0.5in}
\includegraphics[width=0.6\textwidth]{electric_circuits2/circ_diag3_bw.eps}
\vspace{0.1 in}
%\end{center}
...
\begin{minipage}{0.4\textwidth} 
\hspace{0.5in}\includegraphics[width=0.6\textwidth]{electric_circuits2/circ_diag4_bw.eps}
\end{minipage}
\begin{minipage}{0.59\textwidth} 
\vspace{0.2 in}
Prediction: 
