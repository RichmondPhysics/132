...
\instructornote{%
Matt rewrote this significantly in about 2016 (based on earlier version by Jerry), and revised in fall 2019.  Time: pretty long if you do all of it.

Note: use room lights on 1/2.  With the larger aperture settings, the larger background matters.

This lab was rewritten in 2019 so that one could do the activities out of order: 1, 2, 5, 3, 4, though Matt personally advises doing them in order.  Skipping activity 4, or 4 and 5, would also be totally reasonable.
