...
\vspace{0.3cm}
{\centering \resizebox*{0.5\textwidth}{!}{\includegraphics{radiocarbon_dating/rad_counter_bw.eps}} \par}
...
(d) Open the \filename{Radiation\_Counter.cap} file in the \filename{\coursefolder} folder and click
...
\vspace{0.3cm}
{\centering \resizebox*{0.5\textwidth}{!}{\includegraphics{radiocarbon_dating/Cs-137_decay_bw.eps}} \par}
...
(c) Open the \filename{Nuclear\_Decay.cap} file in the \filename{\coursefolder} folder. 
