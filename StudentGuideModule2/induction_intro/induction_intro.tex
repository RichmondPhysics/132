...
\vspace{-0.5in}
    \includegraphics[width=0.4\textwidth]{induction_intro/induction1_setup_2026.pdf}
\end{wrapfigure}
...
\item \textit{Capstone} software (\filename{Induction.cap} experiment file)
\end{itemize}
...
Turn on the computer and open the file \filename{Induction.cap} in the \filename{\coursefolder} folder.
