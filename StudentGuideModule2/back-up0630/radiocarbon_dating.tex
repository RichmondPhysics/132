...
%\vspace{0.3cm}
%{\centering \resizebox*{0.4\textwidth}{!}{\includegraphics{geiger1.eps}} \par}
%\vspace{0.3cm}
...
\vspace{0.3cm}
{\centering \resizebox*{0.5\textwidth}{!}{\includegraphics{rad_counter.eps}} \par}
...
\vspace{0.3cm}
{\centering \resizebox*{0.5\textwidth}{!}{\includegraphics{Cs-137_decay.eps}} \par}
...
\includegraphics[width=5.5in]{pertable3.ps}
\end{center}
