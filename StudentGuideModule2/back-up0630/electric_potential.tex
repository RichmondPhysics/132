...
\textbf{Activity 1: Word Done on a Charge Traveling in a Uniform Electric
Field}
...
\vspace{0.3cm}
{\centering \resizebox*{0.2\textwidth}{!}{\includegraphics{electric_potential_fig_1.eps}} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\centering \resizebox*{0.2\textwidth}{!}{\includegraphics{electric_potential_fig_2.eps}} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\centering \resizebox*{0.2\textwidth}{!}{\includegraphics{electric_potential_fig_3.eps}} \par}
\vspace{0.3cm}
...
{\centering \( \Delta E_{pot}=E_{pot,B}-E_{pot,A}=-\int ^{B}_{A}q\overrightarrow{E}\cdot d\overrightarrow{s} \)\par}
...
as the change in electric potential energy \( \Delta E_{pot} \) per
...
A point charge $q$ produces an electric field that moves out radially
...
and the symbol \( \Delta V \) is just replaces with the symbol V.
...
\vspace{0.3cm}
{\centering \resizebox*{0.4\textwidth}{!}{\includegraphics{electric_potential_fig_4.eps}} \par}
\vspace{0.3cm}
...
\textbf{The Potential Difference Due to Continuous Charge Distributions}
...
to find the electric field an the electric potential at a distance
of x cm from the ring along an axis that is perpendicular to the ring
...
\textbf{Activity 4: Numerical Estimate of the Potential from a Charged
Ring}

(a) Divide the ring into 20 elements of charge \( \Delta q \) and
...
\textbf{Activity 5: Calculation of the Potential from a Charged Ring}
...
(i.e. show that \( \sqrt{x^{2}+a^{2}} \) is a constant and thus can
...
\vspace{0.3cm}
{\centering \resizebox*{0.3\columnwidth}{!}{\includegraphics{electric_potential_fig_7.eps}} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\centering \resizebox*{0.28\textwidth}{!}{\includegraphics{electric_potential_fig_8.eps}} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\centering \resizebox*{0.25\textwidth}{!}{\includegraphics{electric_potential_fig_9.eps}} \par}
\vspace{0.3cm}
