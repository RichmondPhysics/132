...
\newcommand{\coursesection}{\\Fall 2020\\Section 02, T-Th 9:00 am, with Jack Singal} %This defines the section (and/or year) for the title page.
...
\includelab{1}{chargesFields1/EF_EP_1b}
\includelab{1}{chargesFields2/EF_EP_2b}
...
\includelab{1}{capacitance_circuit/capacitance_circuit}
...
\includelab{1}{diffraction_grating/diffraction_grating}
...
\includelab{1}{refraction_of_light/refraction_of_light}
\includelab{1}{refraction_at_spherical_surfaces/refraction_at_spherical_surfaces}
...
\includelab{1}{charles_law/charles_law}
