...
The masking tape is so that students can tape wires to the table, so that they have an actual shape that matches the tidy circuit diagrams in the lab.  This prevents students from wiring up tangles of spaghetti that neither they nor you can troubleshoot. 

The cutting-and-folding paper thing is something I came up with.  \texttt{\textbackslash begin\{opinion\_mode\}} I know it feels a little funny to do paper cutting with college students, \textit{but this really works!}  I have seen the light bulbs go off over so many of their heads when I show them this!  Students tend to try to memorize ``bulbs in parallel have the same voltage, bulbs in series have the same current,'' but they do so formulaicly with no real understanding, so they forget.  Note to instructors: \textit{Really push this!}  Make them do it, and take it seriously!
\texttt{\textbackslash end\{opinion\_mode\}}

Finally, even if you do everything right, this is still a lab where it can be difficult to get to all of the groups that need help fast enough. \textbf{Consider having Matthew Belk or another second pair of hands on call, at least initially.}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{electric_circuits/how_to_measure_current.pdf}
\end{center}
\vspace{-0.2in}
...
\begin{wrapfigure}[1]{l}{0.3\textwidth}
    \vspace{-0.4 in}
    \includegraphics[width=0.3\textwidth]{electric_circuits/circ_diag1.pdf}
\end{wrapfigure}
...
%    \vspace{-0.5 in}
    \includegraphics[width=0.35\textwidth]{electric_circuits/circ_diag2.pdf}
\end{wrapfigure}
...
\vspace{-0.1in}
\begin{flushright}
\includegraphics[width=0.4\textwidth]{electric_circuits/circ_diag3.pdf}
\end{flushright}
\vspace{-0.1in}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{electric_circuits/how_to_fold.pdf}
\end{center}
\vspace{-0.1in}
...
\includegraphics[width=\textwidth]{electric_circuits/circ_diag4.pdf}
\end{minipage}
...
\includegraphics[width=\textwidth]{electric_circuits/circ_diag5.pdf}
\end{minipage}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{electric_circuits/circ_diag6.pdf}
\end{center}
\vspace{-0.1in}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{electric_circuits/circ_diag7.pdf}
\end{center}
\vspace{-0.1in}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{electric_circuits/cutout_page1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{electric_circuits/cutout_page2.pdf}
\cleardoublepage
