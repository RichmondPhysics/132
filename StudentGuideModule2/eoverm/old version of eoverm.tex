...
Solve for the mass $m$ in terms of the radius $r$ of the particle,
$|q|$, $v$, and $B$.
\vspace{35mm}


(d) Using your result from 2.e answer the following questions.
For two particles with the same charge and velocity, but different mass, which one will
...
Typically, we know the kinetic energy $K$ of the charge particle after this
...
Helmholtz coils, the accelerating voltage, and the average radius of the electron.
\vspace{30mm}
...
(l) When you are done, turn down to zero the accelerating voltage, the heater voltage,
the Helmholtz coil voltage, and the current adjust knob.
\vspace{10mm}
