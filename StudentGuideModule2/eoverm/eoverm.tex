...
Create a table in the space below with the headings $V$, $I$, $r_{\rm left}$, 
$r_{\rm right}$, $r_{\rm avg}$, $r^2$. Your data from part (i) above will be the third 
...
\textit{Show} that the units are kilograms.
\vspace{50mm}
