...
\newcommand{\coursesection}{\\Spring 2024} %This defines the section (and/or year) for the title page.
...
\includelab{1}[../../131/StudentGuideModule1/]{archimedes/archimedes}
...
\includelab{1}{electric_field_and_electric_potential/EF_EP_1}
\includelab{1}{electric_field_and_electric_potential/EF_EP_2}
\includelab{1}{electric_field_and_electric_potential/EF_EP_3}
\includelab{1}{electric_field_and_electric_potential/EF_EP_4}
...
\includelab{1}{electric_field_atomic_nucleus/electric_field_atomic_nucleus}
\includelab{1}{charge_dist_water_mol/charge_dist_water_mol}
...
\includelab{1}{lr_circuit/lr_circuit} %not updated for Capstone, unsure of equipment. --MT, 2017
\includelab{1}{lrc_circuit/lrc_circuit} %not updated for Capstone, unsure of equipment. --MT, 2017

%--------------------------------------------
\part{Magnetism}

\includelab{1}{magnetism_qualitative/magnetism_qualitative}
...
\includelab{1}{generator/generator}
...
\includelab{1}{polarization/polarization}
...
\includelab{1}{qmProbability/qmProbability}
